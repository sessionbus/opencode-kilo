...
func writeVersionFixture(t *testing.T, root, releaseVersion string) {
	t.Helper()
	// OpenCode/Kilo have native npm package versions independent of RELEASE_VERSION; neither tied to RELEASE_VERSION; removed product
	// manifest must be required by the guard.
